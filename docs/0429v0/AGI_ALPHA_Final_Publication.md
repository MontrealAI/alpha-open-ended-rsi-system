...
The highest objective is civilizational but claim-bounded: to make machine intelligence economically legible, auditable, reinvestable, and governable as an owner-operator invention engine. AGI ALPHA is designed to compound model capability into work, work into invention, invention into reusable capabilities, capabilities into capital and infrastructure, and capital and infrastructure into compute, science, robotics, laboratories, markets, and useful-energy capacity.
...
|---|---|---|
| 1. Substrate thesis and value-to-energy flywheel | What is AGI ALPHA? | A scalable substrate for intelligence organizations above model substrates. |
| 2. AGI.Eth / ASI.Eth naming and proof-settlement layer | How are actors, authority, and proof made legible? | Low-entropy namespace, ProofBundles, alpha-Work Units, AGI Jobs, Chronicle, and settlement. |
| 3. Implementation evidence corpus and evidence ladder | What exists beyond theory? | MontrealAI repositories, demos, contracts, CI, local/devnet proof surfaces, and a claim-bounded evidence ladder. |
| 4. Market-governed invention stack | How does invention become labor? | MandateEpochs, NettingHouse, Paymaster, OpenClaw, Alpha-Factory, causal substrate, QD archives, and nodes. |
| 5. QD archive, causal substrate, MandateEpochs, and AGI Nodes | How does the system scale search? | Distributed, replayable microjobs and archive-preserving open-ended search. |
| 6. RSI governance | How is recursive invention governed? | Deterministic runner, drift sentinel, ECI, baseline discipline, Move-37 dossiers, and mechanical gates. |
| 7. Safety, validation, and claim boundaries | What prevents overreach? | Risk gates, process evidence, subversion resistance, legal boundaries, and claim-boundary boxes. |
| 8. Evidence Docket and benchmark program | What would prove it? | Real tasks, baselines, proof bundles, replay, cost/risk ledgers, and independent audit. |
| 9. Related work and positioning | What prior art is mechanism-relevant? | Each citation is tied to a mechanism, metric, gate, or evaluation requirement. |
| 10. Conclusion and publication-safe horizon | What is the long-run ambition? | Governed compounding from verified work to capability, infrastructure, compute, science, and useful energy. |
...
| Proof-settlement substrate | Making machine work auditable and payable | ProofBundles, alpha-WU, AGI Jobs, AGIJobManager, Chronicle | protocol evidence in bounded form | no replay, no settlement |
...
| Value-to-energy flywheel | Converting intelligence into compounding capacity | work -> capability -> capital -> capacity -> stronger work | strategic horizon + proxies | overclaim without measured links |

![AGI ALPHA: Scalable Substrate for Intelligence Organizations. The figure shows six stacked substrates: model, agent work, proof-settlement, market-governed invention, governance, and the value-to-energy flywheel.](figures_png/figure00_canonical_architecture.png){ width=98% }

> **Claim boundary.** This paper does not claim that AGI ALPHA has achieved AGI, ASI, autonomous sovereignty, empirical SOTA, market dominance, guaranteed economic return, energy abundance, or civilization-scale capability. It claims that AGI ALPHA is a testable architecture for scalable intelligence organizations: a validator-gated, proof-bearing, RSI-governed substrate for converting model capability into verified machine labor and reinvestable capability. The claim becomes empirical only through Evidence Dockets containing real tasks, baselines, ProofBundles, replay logs, safety/cost ledgers, validator reports, delayed outcomes, and independent reproduction.
...
AGI ALPHA's strategic objective is to convert model intelligence into governed machine labor, governed machine labor into verified invention, verified invention into reusable capability, and reusable capability into capital formation, infrastructure, compute, science, and useful energy capacity. This is the paper's North Star. It is not a claim of present-day superintelligence; it is the architecture that would make such capability economically legible, auditable, reinvestable, and governable.
...
## Owner-Operator Compounding: From Automation Platform to Invention Reserve
...
| Invention machine | Use internally to discover, build, own, and compound high-value assets. | Owner-operator flywheel, invention reserve, strategic capability portfolio, reinvestment into compute, science, energy, and infrastructure. |

AGI ALPHA's highest-value deployment is not merely agents-as-a-service. It is **owner-operator compounding**: using the system to discover opportunities, produce validated artifacts, improve its own work substrate, acquire strategic knowledge, create software/lab/robotics/energy infrastructure, and reinvest gains into compute, science, energy, security, validators, and further machine-labor capacity.
...
| Reinvestment Control Plane | A governance layer that allocates verified gains into compute, data, tools, laboratories, robotics, energy systems, security, and validator capacity. |
...
### Strategic Namespace Moat: Why AGI.Eth / ASI.Eth Matter
...
Caution: the moat becomes real only with adoption, security, proof quality, validator trust, and useful work. Namespace ownership alone does not prove dominance.
...
| Evidence level | Status in the MontrealAI corpus | What it means |
|---|---|---|
| E0: doctrine and formal architecture | Present | The paper and public doctrine define the substrate. |
| E1: implementation scaffold | Present | Repositories instantiate agents, jobs, contracts, nodes, demos, docs, CI, and runbooks. |
| E2: local/devnet replay surfaces | Present in bounded form | Nova-Seeds and related demos expose deterministic local/devnet assertions and proof-first release posture. |
| E3: protocol evidence | Present in bounded form | Escrow contracts, AGI Jobs, node runtime, and AGI.Eth namespace logic provide machine-labor proof/settlement scaffolds. |
| E4: comparative benchmark evidence | Pending | Needs equal-budget baselines across real task families with replayable proof bundles. |
| E5: independent reproduction and delayed outcomes | Pending | Needs third-party replay, external validators, delayed-outcome checks, and audit reports. |

This ladder prevents both underclaim and overclaim. AGI ALPHA now has substantial implementation and protocol evidence, but empirical SOTA remains conditional on reproducible benchmark results.
...
> **Design invariant.** A labor market can operate over invention-space only when search, proof, settlement, and governance are coupled.
...
The breakthrough is not merely that AI agents can do jobs. The breakthrough is that **a labor market can operate over invention-space, not merely task-space**. Invention can be generated, causalized, evaluated, red-teamed, archived, settled, promoted, packaged as capability, reinvested, and used to generate harder future tasks. AGI ALPHA therefore becomes a proof-gated, market-governed invention substrate.
...
| Reinvestment layer | Value Capture Ledger + Invention Reserve | Converts validated invention into owned capability, capital, infrastructure, compute, science, and useful-energy capacity. |
...
-> capability package / invention reserve / reinvestment update
-> next harder mandate
```
...
The archive admits multiple artifact classes: invention candidates, task environments, agent workflows, validators, tool contracts, market mechanisms, causal motifs, software patches, scientific hypotheses, capability packages, foresight artifacts, proof templates, operator playbooks, and reinvestment strategies.
...
Here $F$ is feasibility, $C$ causal coherence, $I$ impact potential, $N$ mechanism novelty, $R$ robustness, $T$ testability, $S$ safety margin, $V$ reinvestment value, and $E$ compute-or-energy leverage.
...
where $F$ is feasibility, $C$ causal coherence, $I$ impact potential, $N$ mechanism novelty, $R$ robustness, $T$ testability, $S$ safety margin, $V$ reinvestment value, and $E$ compute-or-energy leverage.
...
A candidate may be promoted only if it is ALLOW, or CAUTION with red-team approval; feasibility, causal coherence, testability, and safety margin are all at least 4 on the relevant rubric; replayability passes; the ProofBundle is complete; and at least one of impact potential, mechanism novelty, or reinvestment value is at least 4. PROHIBITED artifacts are dropped except for a minimal hash, reason code, and safety category. RESTRICTED artifacts are quarantined and never auto-promoted.
...
**SponsorClaw** creates mandates, opens epochs, inspects archives, adjusts budgets, approves promotion classes, views flywheel contribution, and reviews reinvestment options.
...
> **Design invariant.** Exploration is allowed. Outcome authority is mechanical. Promotion requires evidence. Compounding requires persistence. Autonomy requires authority.
...
| PROMOTE | Rank candidates for deployment, deeper testing, capability packaging, MandateEpoch settlement, invention reserve inclusion, or reinvestment. |
...
$$
\mathrm{RSIState}_t = (x_1, x_2, \ldots, x_{17})
$$

with ordered fields:

```text
cycle_index; prompt_pack_hash; runner_config_hash; state_payload_hash;
archive; scaffolds; candidates; causal_atlas; eci_ledger; evidence_objects;
baseline_library; proof_bundles; promotion_queue; dossier_index; safety_ledger;
drift_sentinel; governance_state.
```
...
![Evidence Contact Ladder. Confidence progresses from simulated reasoning to external validation; stronger empirical claims require stronger contact with execution, replay, stress tests, and external outcomes.](figures_png/figure31_evidence_contact_ladder.png){ width=98% }
...
> **Design invariant.** OMNI improves allocation. It does not confer authority. It may decide where to search next; it may not decide what is true, safe, payable, deployable, or strategically promoted.
...
$$
\mathrm{RSIDossier} = (d_1, d_2, \ldots, d_{19})
$$

with ordered fields:

```text
dossier_id; candidate_id; archive_cell; novelty_distance; advantage_delta;
baselines; reproduction_manifest; stress_tests; evidence_objects; eci_summary;
risk_report; causal_atlas_links; proof_bundle_refs; validator_attestations;
promotion_decision; governance_notes; replay_instructions; public_safe_summary;
private_audit_appendix.
```
...
| Compounding | Stepping-stone retention, lineage metaproductivity, QD archive coverage, regression detection, and reinvestment policy. |
...
| Phase 2 - Strategic autonomy, 12-24 months | Policy-shock stress suites, persistent RSI lineages, validator council, security hardening, partner execution lanes, invention capital allocation, third-party replay/audit. | Validated compounding discovery rate; independent replay success; real-task cost reduction over cycles; zero critical safety violations. |
...
The paper does not claim achieved superintelligence, achieved ASI, autonomous sovereignty, guaranteed market dominance, energy abundance, or civilization-scale capability. It claims a testable architecture: a deterministic, validator-gated, market-governed, recursively improving intelligence-organization substrate whose outputs become empirical only through executed evidence, replayable ProofBundles, baseline comparisons, safety ledgers, cost/risk accounting, delayed outcomes, and independent audit.

## Value Capture, Capital Formation, and Reinvestment Governance

The civilizational objective depends not only on capability, but on ownership, value capture, and disciplined reinvestment. The paper therefore does not stop at "agents do work." It models how work becomes owned capability and how owned capability compounds.

**Value Capture Ledger.** Tracks how accepted evidence bundles become revenue, intellectual property, internal tools, cost reductions, infrastructure plans, scientific assets, market mechanisms, or strategic capabilities.

**Reinvestment Policy.** Allocates verified gains into compute, data, tooling, security, validator capacity, research, robotics, laboratories, energy systems, and strategic reserves.
...
A superintelligent invention engine would be valuable only if its outputs can be captured, governed, reinvested, and compounded without creating unacceptable systemic risk.
...
|---|---|
| Subversion-Resistant Validation | Prevents strategically deceptive agents from converting hidden failure, backdoors, collusion, or unsafe artifacts into accepted work, protecting the capital and infrastructure flywheel. |
...
| Value-Capture and Reinvestment Layer | Ensures verified invention becomes owned capability, capital, infrastructure, useful energy, compute, and stronger future labor. |
...
**Subversion-Resistant Validation Layer.** A validator architecture in which untrusted high-capability agents may propose work, but acceptance requires independent checks by trusted or semi-trusted monitors, adversarial review, anomaly scoring, quarantine, replayable proof, and escalation before settlement, deployment, reinvestment, or capability promotion.

Without subversion resistance, verified work is not investable. Capital formation built on hidden failure becomes systemic risk.

### Process-Resolved Evidence Validation: From Output Checks to Investable Proof

Capital and infrastructure should not be built on final answers alone. They require process integrity.
...
Process integrity turns machine labor into auditable assets that can be reused, financed, insured, licensed, or reinvested.
...
Diversity preserves optionality. Optionality is crucial for frontier invention, capital allocation, and energy/infrastructure discovery.
...
A high-value owner-operator engine needs markets, but untested markets can destroy value through flash-crash dynamics, collusion, Sybil attacks, validator overload, or harmful concentration.
...
- $K_{\mathrm{capitalization}}$: conversion of verified capability into reinvestable value.
...
- $R_{\mathrm{concentration}}$: harmful concentration, monopoly abuse, market capture, or social externality risk.
...
Here, verified novelty means new capability relative to the archive rather than merely new text; learnability means neither trivial nor impossible; interestingness means useful, strategically relevant, and non-redundant; and flywheel contribution means measurable progress toward verified work, capital formation, compute, science, infrastructure, or useful energy.
...
9. Does it support owner-operator compounding?
...
The claim becomes empirical only through real-task evidence: benchmark results, external validators, process-resolved evidence bundles, subversion tests, cost/risk ledgers, reproducible traces, safety audits, delayed-outcome measurements, capital/reinvestment ledgers, and independent review.
...
| Claim | Current status | Evidence required | Where verified |
|---|---|---|---|
| Formal AGI ALPHA architecture | Supported as formal architecture | definitions, protocols, gates, metrics | paper sections and appendices |
| MontrealAI implementation scaffold | Supported as implementation scaffold | repositories, demos, CI, contracts, nodes, docs | implementation evidence corpus |
| Proof-settlement protocol | Partially supported by bounded local/devnet surfaces | replayable proof bundles, validator logs, settlement receipts | AGI Jobs / AGI.Eth sections |
| Real-task coordination | Planned evaluation protocol | baselines, traces, cost/risk ledgers, validator reports | Evidence Docket |
| Scalability with agents/nodes | Pending comparative benchmark evidence | scaling curves over agents/nodes and validators | Coordination Scaling Law Benchmark |
| Safety under tool use | Pending real-task safety evidence | safety ledgers, policy gates, subversion tests, red-team logs | Evidence Docket |
| RSI persistence | Planned evaluation protocol | state hashes, drift sentinel failures, append-only ledgers | RSI Evidence Docket |
| Market-governed invention | Architecture specified; empirical proof pending | MandateEpoch proof pack and archive deltas | Experiments 39-45 |
| Empirical SOTA | Not claimed | equal-budget wins against baselines with independent replay | benchmark program |
| Value-to-energy flywheel | Strategic horizon, not present claim | measured links from work to capability, capital, infrastructure, compute, science, useful energy | longitudinal evidence program |
...
| AGI.Eth / ASI.Eth provide institutional namespace positioning | Supported as architectural positioning, not dominance proof | Adoption, secure deployment, resolver reliability, registry-governed recognition, replayable proof bundles, validator trust, alpha-WU calibration, and settlement reliability |
...
10. **Owner-operator compounding architecture.** It introduces Sovereign Invention Reserve, Reinvestment Control Plane, Capital-to-Compute-to-Energy Ledger, Strategic Capability Asset Map, and Value Capture Ledger.
...
| Meta-learning learning algorithms | Meta-learn routers, ProofZero planners, experience-to-policy compression, reward governance, settlement rules, and reinvestment policies. |
...
- B7: full AGI ALPHA with subversion-resistant validation, process-resolved validation, proof-native workbench, capability package library, diversity-preserving frontier, tiered validator council, agent economy simulation sandbox, and value-capture/reinvestment layer.
...
**Metrics.** $D_{\mathrm{open}}$, $D_{\mathrm{real}}$, $D_{\mathrm{civ++}}$, best descendant verified value, capability archive diversity, transfer across task families, safety incidents, proof-bundle replay rate, lineage metaproductivity, capital/reinvestment contribution, and $K2_{\mathrm{proxy}}$.
...
The Transformer made intelligence scalable inside models. AGI ALPHA aims to make intelligence scalable across institutions. Its object is not a single answer, agent, or benchmark score, but a governed substrate in which machine labor is named, authorized, executed, proven, validated, settled, remembered, improved, and reinvested. If this architecture works, verified intelligence becomes a compounding institutional resource: work becomes capability; capability becomes capital and infrastructure; infrastructure expands compute, science, and useful energy; and expanded capacity enables stronger, safer, more general work. The burden is empirical. AGI ALPHA must earn every claim through replayable evidence, real-task baselines, validators, safety ledgers, and independent audit.


AGI ALPHA is not a chatbot, not an ordinary automation platform, and not an unconstrained autonomy claim. It is a commercially independent, validator-gated, subversion-resistant, experience-grounded, planning-capable, sovereign evolutionary intelligence-organization substrate whose purpose is to convert verified machine labor into reusable capability, capital formation, infrastructure, compute, science, useful energy, and stronger future work.
...
Final implementation positioning: AGI ALPHA becomes truly differentiated when invention can be manufactured as verified labor. AGI Jobs settle it; Alpha-Factory searches it; causal-substrate services test mechanisms; QD archives preserve stepping stones; OpenClaw supervises it; AGI Nodes compute it; NettingHouse clears it; Paymaster funds utility-denominated mandates; AGIJobManager finalizes it; and the value-to-energy flywheel reinvests it into reusable capability, capital, infrastructure, compute, science, and useful-energy capacity.
...
AGI_Eth_Institutional_v0 is used as a primary-source institutional design document, not as empirical proof of achieved AGI, ASI, market dominance, or Kardashev-scale capability [73]. Its role is to specify how the AGI ALPHA organizational substrate becomes institutionally legible at machine speed: identity, proof, settlement, and governance are made nameable, replayable, auditable, and policy-bound.
...
# Appendix K: publication apparatus and navigation

This appendix preserves content while making the external publication easier to review, audit, and reproduce. No substantive mechanism, formalism, experiment, citation, implementation-evidence claim, or claim boundary has been removed in this polish pass.

## Figure index

| Figure | Purpose | Section | Main claim supported |
|---|---|---|---|
| Canonical architecture | Shows the six substrate layers from model to flywheel | Reader's Map | AGI ALPHA scales intelligence organizations above model substrates |
| Model vs. organization substrate | Contrasts Transformer and AGI ALPHA | Substrate thesis | model capability is not institutional capability |
| Civilizational flywheel | Shows verified work compounding into capacity | Value-to-energy flywheel | strategic horizon is operationalized as measurable proxies |
| AGI.Eth institutional stack | Shows identity, work OS, runtime surfaces | AGI.Eth / ASI.Eth | namespace + proof + settlement + governance |
| Proof-settlement chain | Shows request to Chronicle | ProofBundle / alpha-WU | no replay, no settlement |
| Market-governed invention foundry | Shows Alpha-Factory, OpenClaw, NettingHouse, nodes | Market-governed invention | invention becomes validated labor |
| RSI control plane | Shows TARGET to PROMOTE with gates | RSI governance | recursive invention requires deterministic governance |
| Evidence Contact Ladder | Shows E0-E5 evidence levels | ECI | confidence cannot inflate without execution |

## Table index

| Table | Purpose | Section | Main claim supported |
|---|---|---|---|
| At a Glance | Executive navigation across layers | front matter | paper is comprehensive but navigable |
| Status of Evidence | Distinguishes architecture, implementation, and empirical proof | scope | no hidden empirical claims |
| AGI.Eth recognition table | Separates global and environment-scoped identity | namespace | official recognition is registry-driven |
| Market-governed invention architecture | Maps components to functions and gates | invention stack | invention-space can be organized as labor |
| Baseline ladders | Defines fair comparators | experiments | empirical claims require baselines |
| Mechanism-to-flywheel table | Connects mechanisms to capacity compounding | flywheel | every mechanism serves the mission |

## Notation table

| Symbol | Meaning | First introduced | Status |
|---|---|---|---|
| $W_{verified}$ | externally accepted verified machine work | flywheel | empirical when measured |
| $K_{capital}$ | reinvestable capital or value capture | flywheel | proxy metric |
| $I_{infrastructure}$ | labs, robotics, markets, data centers, tools | flywheel | proxy metric |
| $E_{useful}$ | useful energy or energy-efficiency contribution | flywheel | strategic proxy |
| $C_{compute}$ | compute capacity, efficiency, or access | flywheel | empirical proxy |
| $D_{real}$ | real-task verified work efficiency metric | metrics | empirical |
| $D_{civ++}$ | civilizational flywheel quality metric | metrics | strategic + empirical proxies |
| $D_{civ,RSI}$ | RSI-governed civilizational metric | RSI | strategic + empirical proxies |
| $ECI(x)$ | Evidence Contact Index | RSI | empirical evidence quality |
| (x)0 cost-risk-adjusted baseline advantage | RSI baseline discipline | empirical |
| $RSIState_t$ | deterministic RSI state object | RSI | implementation artifact |
| $ProofBundle$ | settlement-grade proof object | proof-settlement | implementation + empirical |
| $alpha	ext{-}WU$ | alpha-Work Unit, verified machine-labor metrology | proof-settlement | calibration pending |

## Glossary

**AGI ALPHA.** A commercially independent substrate for intelligence organizations: agents, jobs, validators, tools, memory, markets, settlement, governance, and reinvestment organized into proof-bearing work.

**alpha-AGI Ascension.** The proposed operating regime in which heterogeneous agents form, execute, validate, and dissolve coalitions to produce verified, risk-bounded work under continuous inflows.

**Intelligence organization.** A governed arrangement of models, agents, tools, validators, memory, markets, proof, settlement, and policy that converts model capability into verified institutional work.

**ProofBundle.** A settlement-grade evidence object containing task spec, policy context, environment pins, artifacts, traces, logs, signatures, validator attestations, replay result, dispute status, and receipt pointers.

**alpha-Work Unit / alpha-WU.** A policy-parameterized unit of verified machine labor; not a raw token count, GPU-hour, or benchmark score.

**MandateEpoch.** An epoch-level work unit in which a mandate authorizes many off-chain invention microjobs whose receipts are batched, challenged, rooted, validated, and settled as a coherent unit.

**NettingHouse.** The batching and clearing layer for invention receipts, archive-delta roots, payout roots, quarantine roots, and challenges.

**Paymaster.** The funding rail that budgets and funds mandate epochs while enforcing settlement constraints.

**OpenClaw.** The sponsor, reviewer, and operator shell; it is not the scheduler, archive, or settlement source of truth.

**Alpha-Factory.** The invention engine that proposes, causalizes, evaluates, red-teams, archives, promotes, and packages candidates.

**AGI Node.** A verifiable runtime that executes generation, evaluation, replay, archive maintenance, validation, and packaging work under identity, metering, and audit controls.

**AGI.Eth / ASI.Eth.** Low-entropy institutional namespaces for identity, authority, proof, settlement, and governance; not claims of achieved AGI or ASI.

**RSIState.** The deterministic state object for recursive invention governance.

**ECI.** Evidence Contact Index, an evidence hierarchy preventing confidence inflation without execution and replay.

**OMNI.** In this paper, an allocation signal for interestingness and exploration pressure, never an outcome authority.

**Move-37 dossier.** A high-novelty, high-advantage breakthrough package requiring reproduction, stress testing, persistence, evidence, and governance review.

**Evidence Docket.** The public or internal package required for empirical claims: tasks, baselines, runs, proof bundles, replay logs, safety/cost ledgers, validator reports, and summary tables.

**Owner-operator flywheel.** The reinvestment loop by which verified work becomes reusable capability, capital, infrastructure, compute, science, useful energy, and stronger future work.

## Claims matrix

| Claim | Type | Status | Required proof |
|---|---|---|---|
| AGI ALPHA is a scalable organizational substrate | architectural | defined in paper | formal definitions, mechanisms, implementation scaffold |
| AGI Alpha RSI is a deterministic governance control plane | architectural | defined in paper | runner manifests, state hashes, drift sentinel, ECI ledger |
| AGI.Eth / ASI.Eth can reduce namespace entropy | architectural hypothesis | benchmark specified | namespace entropy benchmark |
| ProofBundles can reduce settlement ambiguity | architectural hypothesis | benchmark specified | proof bundle replay and false-payout benchmark |
| alpha-WU can measure verified machine labor better than crude counts | measurement hypothesis | calibration pending | alpha-WU metrology benchmark |
| AGI ALPHA coordinates agents better than baselines | empirical | pending | real-task Evidence Docket with equal-budget baselines |
| RSI improves recursive invention governance | empirical | pending | replayability, ECI, Move-37, and dossier benchmarks |
| Value-to-energy compounding can be measured | strategic horizon | proxy defined | longitudinal evidence linking work to capacity |
...
14_move37_dossiers/
15_summary_tables/
16_independent_replay_notes/
```

A valid docket must answer what task was performed, which agents and tools participated, what the router decided, what baseline was used, what evidence was executed, what was replayed, what was externally validated, what it cost, what safety risks appeared, what was blocked or quarantined, what the advantage delta was, what persisted into the archive, and what the system learned for the next cycle.

## Reproducibility checklist

1. Task manifest is public or auditable.
2. Baselines are declared before evaluation.
3. Agent constellation and role contracts are logged.
4. Tool calls are scoped, timestamped, and replayable where possible.
5. ProofBundle is complete.
6. Validator reports are signed or otherwise attributable.
7. Safety ledger records blocked and quarantined actions.
8. Cost ledger includes compute, tokens, tools, human review, and latency.
9. RSI state hashes are preserved for recursive cycles.
10. Independent replay instructions are present.
11. Failures are reported, not hidden.
12. Promotion rule is applied mechanically.

## Citation audit

Every citation in the publication must serve at least one mechanism: learned coordination, experience streams, value-relevant planning, validated search, directed evolution, open-ended task generation, agentic-system design, self-play with verification, sandbox markets, task-defined curricula, lineage metaproductivity, dynamic verifiable evolution, real-task agents, safety oversight, namespace/proof-settlement infrastructure, or implementation evidence. Decorative citation use is not publication-safe.

## Legal and commercial claim-boundary audit

- $AGIALPHA is described only as utility infrastructure for staking, escrow, settlement, metering, routing, slashing, dispute handling, and protocol operation.
- The paper does not describe $AGIALPHA as equity, profit rights, dividends, ownership, yield, guaranteed return, investment exposure, or guaranteed appreciation.
- AGI.Eth / ASI.Eth are framed as strategic namespace infrastructure, not proof of dominance or achieved AGI/ASI.
- Node economics are hypotheses to be tested under realistic utilization, liquidity, verification overhead, energy costs, hardware depreciation, model/API costs, slashing risk, and validator latency.
- Internal sources are translated into publication-safe governance language; private keys, private endpoints, sensitive controls, and non-public operational details are not disclosed.

## Reviewer-risk memo

| Reviewer concern | Publication answer |
|---|---|
| Is the paper too broad? | It is intentionally comprehensive; the Reader's Map and At-a-Glance table define the spine. |
| What is the core technical contribution? | A proof-bearing, validator-gated, RSI-governed substrate for intelligence organizations. |
| What is new beyond multi-agent systems? | Proof-settlement, namespace authority, value-to-energy reinvestment, RSI governance, and evidence dockets. |
| What is new beyond agent marketplaces? | Invention-space labor, MandateEpochs, ProofBundles, QD archives, causal substrate, and RSI promotion gates. |
| What is actually implemented? | MontrealAI repositories provide implementation scaffolds, demos, contracts, CI, local/devnet proof surfaces, nodes, and runbooks. |
| What is empirically proven? | Architecture and implementation scaffolds are supported; comparative real-task SOTA remains pending. |
| Are metrics measurable? | Each metric is labeled empirical or strategic, and promotion rules require measurable evidence. |
| Are AGI.Eth / ASI.Eth claims overreaching? | They are namespace infrastructure and strategic optionality, not proof of dominance. |
| Is token language legally clean? | The token is described only as utility infrastructure. |
| What falsifies the architecture? | Failure to beat baselines under equal budgets, unreplayable traces, unsafe promotion, or poor cost/risk performance. |

## One-page executive summary

AGI ALPHA proposes a scalable substrate for intelligence organizations. The paper's contribution is not a single agent, model, market, or token, but an institutionally governed architecture in which model capability becomes verified machine labor. Verified labor becomes reusable invention; reusable invention becomes capital, infrastructure, compute, science, useful energy, and stronger future work. The architecture integrates AGI.Eth / ASI.Eth naming, ProofBundles, alpha-Work Units, AGI Jobs, AGI Nodes, market-governed invention, QD archives, causal substrates, OpenClaw operator controls, and AGI Alpha RSI governance. The central claim is architectural and testable. It becomes empirical only through Evidence Dockets containing real tasks, baselines, proof bundles, replay logs, validator reports, safety/cost ledgers, and independent audit.

## One-page scientific contribution summary

The scientific contribution is a mechanism-bound synthesis: learned coordination determines who should think, act, verify, and stop; experience streams convert action into training substrate; value-relevant planning searches over abstract work states; validated search anchors generation to external proof; open-ended and AI-generating methods produce new tasks, environments, agents, and workflows; market mechanisms allocate resources; and RSI makes recursive improvement deterministic, replayable, baseline-comparative, and dossier-governed.

## One-page institutional architecture summary

The institutional architecture has five anchors: AGI.Eth / ASI.Eth for low-entropy identity and authority; AGI Jobs for proof-settlement work; AGI Nodes for verifiable runtime; ProofBundles and alpha-WU for audit and metrology; and AGI Alpha RSI for deterministic recursive governance. The invariant is: no value without evidence, no autonomy without authority, no settlement without validation, and no empirical SOTA claim without an Evidence Docket.

## One-page evidence standard summary

An evidence standard is valid only when it contains a task manifest, baselines, AGI ALPHA run traces, proof bundles, replay logs, cost ledgers, safety ledgers, validator reports, alpha-WU calibration, RSI state hashes, ECI ledger, Move-37 dossiers where relevant, summary tables, and independent replay notes. Internal demos, repository activity, and local/devnet proof surfaces count as implementation evidence; empirical performance requires comparative, replayable, real-task evidence.

## One-page visual design guide

Use deep institutional blue and charcoal as primary colors, muted gold as an accent, and restrained violet or green only for secondary semantic emphasis. Use thin strokes, high-contrast labels, large figure text, and captions that state the argument. Avoid sci-fi imagery, crypto-style visual excess, blurry screenshots, unreadable tables, and decorative complexity. Every figure should answer: what flows, what gates it, what evidence is produced, and what risk is bounded.

## Content preservation ledger

| Action | Content impact | Rationale |
|---|---|---|
| Added Executive Thesis | no content removed | orients readers in 30 seconds |
| Added Reader's Map and At-a-Glance table | no content removed | makes long paper navigable |
| Added canonical architecture figure | no content removed | provides visual anchor |
| Added claim-boundary boxes | no content removed | prevents hidden empirical claims |
| Added publication apparatus appendix | no content removed | adds figure/table indexes, notation, glossary, claims matrix, audits, and reviewer memo |
| Standardized selected headings and design-invariant boxes | no content removed | converts repetition into deliberate reinforcement |
| Preserved all mechanisms, formalisms, experiments, citations, and institutional doctrine | full preservation | satisfies non-shortening requirement |

## Final acceptance gate

The publication is ready only if the thesis is understandable in 30 seconds; the paper remains comprehensive; the full ambition remains intact; every major mechanism has a formal object, protocol, or gate; implementation evidence is distinguished from empirical proof; Evidence Docket requirements are clear; real-task scaling benchmarks are specified; legal and commercial boundaries are clean; AGI.Eth / ASI.Eth are framed as infrastructure; $AGIALPHA is framed only as utility infrastructure; RSI is the deterministic governance control plane; OMNI is allocation-only; Move-37 claims require dossiers; ProofBundles and alpha-WU are central; the value-to-energy flywheel is ambitious but claim-bounded; figures and tables are readable; citations are mechanism-bound; and the conclusion is powerful without overclaiming.
